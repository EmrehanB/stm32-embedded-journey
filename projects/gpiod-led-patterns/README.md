...
internet kesintisi sırasında can sıkıntısından yazılmış basit bir STM32F407G-DISC1'in kart üstü dört LED'ini (PD12–PD15) register seviyesinde kontrol eden bir blink dizisi. Önce her LED sırayla tek tek yanıp sönüyor, sonra hepsi birlikte 4 tur yanıp sönüyor, döngü baştan başlıyor.
